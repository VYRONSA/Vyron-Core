...
export const metadata = { title: "About | VYRON Software" };
    ...
    <div className="site">
      ...
      <main className="page-simple">
        <div className="container legal">
          <span className="pill">ABOUT VYRON</span>
          <h1>South African SaaS. Global potential.</h1>
          <p>VYRON Software builds modern business software for companies that need control, visibility and intelligent operations.</p>
          <p>The VYRON suite covers workforce management, marketing, costing, maintenance, farming, construction, recruitment and future AI-powered business intelligence.</p>
        </div>
      </main>
      <Footer />
    </div>
