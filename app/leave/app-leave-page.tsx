...
export default function LeavePage() {
  ...
  return (
    <main className="min-h-screen overflow-hidden bg-[radial-gradient(circle_at_18%_8%,rgba(34,211,238,0.22),transparent_30%),radial-gradient(circle_at_86%_18%,rgba(37,99,235,0.18),transparent_34%),linear-gradient(135deg,#050914_0%,#07101f_34%,#eef7ff_34%,#f8fbff_100%)] p-4 text-slate-950 md:p-8">
      <div className="pointer-events-none fixed inset-0 z-0">
        ...
        <div className="absolute inset-0 bg-[linear-gradient(135deg,rgba(5,9,20,0.98)_0%,rgba(7,16,31,0.96)_34%,rgba(238,247,255,0.96)_34%,rgba(248,251,255,0.98)_100%)]" />
      </div>
      <section className="relative z-10 mx-auto max-w-7xl">
        <button
          onClick={() => router.back()}
          className="mb-6 inline-flex items-center gap-2 rounded-full border border-cyan-300/20 bg-[#06101f] px-5 py-3 text-sm font-black text-cyan-300 shadow-[0_18px_45px_rgba(8,47,73,0.28),0_0_26px_rgba(34,211,238,0.18)] transition hover:-translate-y-0.5 hover:text-white"
        >
          <ArrowLeft className="h-4 w-4" />
          Back
        </button>
        <header className="relative overflow-hidden rounded-[2.2rem] border border-white/75 bg-white/90 p-7 text-[#06101f] shadow-[0_26px_86px_rgba(15,23,42,0.17),0_0_36px_rgba(34,211,238,0.12)] backdrop-blur-2xl md:p-8">
        ...
        <section className="mt-6 grid gap-6 lg:grid-cols-[0.82fr_1.18fr]">
          <div className="space-y-6">
            <div className="rounded-[2rem] border border-white/75 bg-white/90 p-6 shadow-[0_22px_70px_rgba(15,23,42,0.14)] backdrop-blur-2xl transition duration-200 hover:-translate-y-0.5 hover:border-cyan-200/80 hover:shadow-[0_28px_86px_rgba(15,23,42,0.18),0_0_36px_rgba(34,211,238,0.12)]">
