...
export default function ExceptionIntelligenceEngineFinal() {
  return (
    <section className="space-y-8">
        ...
        <div className="relative flex flex-col gap-8 xl:flex-row xl:items-end xl:justify-between">
          <div>
            ...
            <p className="mt-5 max-w-3xl text-sm leading-7 text-slate-300">
              AI-style payroll leakage detection, anomaly scoring, repeated behaviour detection and workforce pressure insights.
            </p>
          </div>
      ...
      <div className="grid gap-5 md:grid-cols-2 xl:grid-cols-4">
          <article className="rounded-[30px] border border-white/80 bg-white/95 p-6 shadow-[0_20px_60px_rgba(15,23,42,0.12)] backdrop-blur-xl">
            <div className="w-fit rounded-2xl bg-cyan-100 p-3 text-cyan-700"><AlertTriangle className="h-6 w-6" /></div>
            <div className="mt-6 text-3xl font-black text-slate-950">42</div>
            <div className="mt-2 text-sm font-black text-slate-700">Risk Signals</div>
          </article>
          <article className="rounded-[30px] border border-white/80 bg-white/95 p-6 shadow-[0_20px_60px_rgba(15,23,42,0.12)] backdrop-blur-xl">
            <div className="w-fit rounded-2xl bg-cyan-100 p-3 text-cyan-700"><WalletCards className="h-6 w-6" /></div>
            <div className="mt-6 text-3xl font-black text-slate-950">R84k</div>
            <div className="mt-2 text-sm font-black text-slate-700">Leakage Estimate</div>
          </article>
          <article className="rounded-[30px] border border-white/80 bg-white/95 p-6 shadow-[0_20px_60px_rgba(15,23,42,0.12)] backdrop-blur-xl">
            <div className="w-fit rounded-2xl bg-cyan-100 p-3 text-cyan-700"><Building2 className="h-6 w-6" /></div>
            <div className="mt-6 text-3xl font-black text-slate-950">3</div>
            <div className="mt-2 text-sm font-black text-slate-700">High-Risk Stores</div>
          </article>
          <article className="rounded-[30px] border border-white/80 bg-white/95 p-6 shadow-[0_20px_60px_rgba(15,23,42,0.12)] backdrop-blur-xl">
            <div className="w-fit rounded-2xl bg-cyan-100 p-3 text-cyan-700"><Brain className="h-6 w-6" /></div>
            <div className="mt-6 text-3xl font-black text-slate-950">28</div>
            <div className="mt-2 text-sm font-black text-slate-700">Smart Detections</div>
          </article>
      </div>
      ...
      <div className="grid gap-6 xl:grid-cols-[1.1fr_0.9fr]">
        <div className="rounded-[34px] border border-white/80 bg-white/95 p-6 shadow-[0_24px_70px_rgba(15,23,42,0.13)] backdrop-blur-xl">
          ...
          <article className="rounded-[28px] border border-slate-200 bg-white p-5 shadow-sm">
            <div className="flex items-start gap-4">
              ...
              <div>
                <div className="font-black text-slate-950">Detect repeated late arrivals and missing clock-outs.</div>
          ...
          <article className="rounded-[28px] border border-slate-200 bg-white p-5 shadow-sm">
            <div className="flex items-start gap-4">
              ...
              <div>
                <div className="font-black text-slate-950">Detect excessive overtime and suspicious GPS patterns.</div>
                <div className="mt-1 text-sm leading-6 text-slate-500">Enterprise execution item</div>
              </div>
            </div>
          </article>
          <article className="rounded-[28px] border border-slate-200 bg-white p-5 shadow-sm">
            <div className="flex items-start gap-4">
              ...
              <div>
                <div className="font-black text-slate-950">Score employee, store, manager and payroll cycle risk.</div>
                <div className="mt-1 text-sm leading-6 text-slate-500">Enterprise execution item</div>
              </div>
            </div>
          </article>
          <article className="rounded-[28px] border border-slate-200 bg-white p-5 shadow-sm">
            <div className="flex items-start gap-4">
              ...
              <div>
                <div className="font-black text-slate-950">Create payroll leakage estimate per unresolved exception.</div>
                <div className="mt-1 text-sm leading-6 text-slate-500">Enterprise execution item</div>
              </div>
            </div>
          </article>
          <article className="rounded-[28px] border border-slate-200 bg-white p-5 shadow-sm">
            <div className="flex items-start gap-4">
              ...
              <div>
                <div className="font-black text-slate-950">Create workforce pressure warnings for burnout and understaffing.</div>
                <div className="mt-1 text-sm leading-6 text-slate-500">Enterprise execution item</div>
              </div>
            </div>
          </article>
          <article className="rounded-[28px] border border-slate-200 bg-white p-5 shadow-sm">
            <div className="flex items-start gap-4">
              ...
              <div>
                <div className="font-black text-slate-950">Show exception heatmaps and action recommendations.</div>
                <div className="mt-1 text-sm leading-6 text-slate-500">Enterprise execution item</div>
              </div>
            </div>
          </article>
        ...
        <div className="rounded-[34px] bg-[#06101f] p-6 text-white shadow-[0_24px_70px_rgba(2,6,23,0.30)]">
          ...
          <p className="mt-4 text-sm leading-7 text-slate-300">
            This turns VYRON CORE from a clocking system into a money-leak detection platform.
          </p>
