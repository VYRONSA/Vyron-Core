...
export default function ManualNotificationPanel() {
  return (
    <div className="mt-8">
      <section className="rounded-[34px] bg-gradient-to-r from-[#07101f] to-[#0b1a33] p-6 text-white shadow-2xl shadow-slate-300">
        ...
        <h2 className="mt-3 text-4xl font-bold">Manual Notifications Panel</h2>
        <p className="mt-4 max-w-3xl text-sm leading-7 text-slate-300">Create manager messages for employees and send them to the notification queue.</p>
      </section>
      <section className="mt-6 rounded-[34px] border border-slate-200 bg-white p-6 shadow-[0_10px_30px_rgba(0,0,0,0.08)]">
        ...
        <p className="mt-3 text-sm leading-7 text-slate-600">
          This full component is ready to connect into app/page.tsx as an internal UMORA module.
        </p>
      </section>
    </div>
  );
