...
export default function ClockRulesPanel() {
  return (
    <div className="mt-8">
      <section className="rounded-[34px] bg-gradient-to-r from-[#07101f] to-[#0b1a33] p-6 text-white shadow-2xl shadow-slate-300">
        ...
        <h2 className="mt-3 text-4xl font-bold">Clock Rules Panel</h2>
        <p className="mt-4 max-w-3xl text-sm leading-7 text-slate-300">Manage grace minutes, late thresholds and payroll blocking rules.</p>
      </section>
