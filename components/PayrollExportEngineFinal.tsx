...
export default function PayrollExportEngineFinal() {
  return (
    <section className="space-y-8">
        ...
        <div className="relative flex flex-col gap-8 xl:flex-row xl:items-end xl:justify-between">
          <div>
            ...
            <p className="mt-5 max-w-3xl text-sm leading-7 text-slate-300">
              Final commercial payroll layer with export validation, approval workflow, freeze logic, export history and payroll-ready controls.
            </p>
          </div>
      ...
      <div className="grid gap-5 md:grid-cols-2 xl:grid-cols-4">
          <article className="rounded-[30px] border border-white/80 bg-white/95 p-6 shadow-[0_20px_60px_rgba(15,23,42,0.12)] backdrop-blur-xl">
            ...
            <div className="mt-6 text-3xl font-black text-slate-950">87%</div>
            <div className="mt-2 text-sm font-black text-slate-700">Export Readiness</div>
          </article>
          <article className="rounded-[30px] border border-white/80 bg-white/95 p-6 shadow-[0_20px_60px_rgba(15,23,42,0.12)] backdrop-blur-xl">
            <div className="w-fit rounded-2xl bg-cyan-100 p-3 text-cyan-700"><LockKeyhole className="h-6 w-6" /></div>
            <div className="mt-6 text-3xl font-black text-slate-950">14</div>
            <div className="mt-2 text-sm font-black text-slate-700">Blocked Items</div>
          </article>
          <article className="rounded-[30px] border border-white/80 bg-white/95 p-6 shadow-[0_20px_60px_rgba(15,23,42,0.12)] backdrop-blur-xl">
            <div className="w-fit rounded-2xl bg-cyan-100 p-3 text-cyan-700"><FileSpreadsheet className="h-6 w-6" /></div>
            <div className="mt-6 text-3xl font-black text-slate-950">5</div>
            <div className="mt-2 text-sm font-black text-slate-700">Export Types</div>
          </article>
          <article className="rounded-[30px] border border-white/80 bg-white/95 p-6 shadow-[0_20px_60px_rgba(15,23,42,0.12)] backdrop-blur-xl">
            <div className="w-fit rounded-2xl bg-cyan-100 p-3 text-cyan-700"><ShieldCheck className="h-6 w-6" /></div>
            <div className="mt-6 text-3xl font-black text-slate-950">4</div>
            <div className="mt-2 text-sm font-black text-slate-700">Approval Steps</div>
          </article>
      </div>
        ...
        <div className="rounded-[34px] border border-white/80 bg-white/95 p-6 shadow-[0_24px_70px_rgba(15,23,42,0.13)] backdrop-blur-xl">
          ...
          <article className="rounded-[28px] border border-slate-200 bg-white p-5 shadow-sm">
            <div className="flex items-start gap-4">
              ...
              <div>
                <div className="font-black text-slate-950">Add Sage, SimplePay, Generic CSV, Excel and summary PDF export options.</div>
          ...
          <article className="rounded-[28px] border border-slate-200 bg-white p-5 shadow-sm">
            <div className="flex items-start gap-4">
              ...
              <div>
                <div className="font-black text-slate-950">Freeze payroll export while unresolved blockers exist.</div>
                <div className="mt-1 text-sm leading-6 text-slate-500">Enterprise execution item</div>
              </div>
            </div>
          </article>
          <article className="rounded-[28px] border border-slate-200 bg-white p-5 shadow-sm">
            <div className="flex items-start gap-4">
              ...
              <div>
                <div className="font-black text-slate-950">Track export date, user, employee count, export type and warnings.</div>
                <div className="mt-1 text-sm leading-6 text-slate-500">Enterprise execution item</div>
              </div>
            </div>
          </article>
          <article className="rounded-[28px] border border-slate-200 bg-white p-5 shadow-sm">
            <div className="flex items-start gap-4">
              ...
              <div>
                <div className="font-black text-slate-950">Require manager, HR and payroll admin approval before export.</div>
                <div className="mt-1 text-sm leading-6 text-slate-500">Enterprise execution item</div>
              </div>
            </div>
          </article>
          <article className="rounded-[28px] border border-slate-200 bg-white p-5 shadow-sm">
            <div className="flex items-start gap-4">
              ...
              <div>
                <div className="font-black text-slate-950">Validate duplicate shifts, missing clock-outs and abnormal overtime.</div>
                <div className="mt-1 text-sm leading-6 text-slate-500">Enterprise execution item</div>
              </div>
            </div>
          </article>
          <article className="rounded-[28px] border border-slate-200 bg-white p-5 shadow-sm">
            <div className="flex items-start gap-4">
              ...
              <div>
                <div className="font-black text-slate-950">Store export history and rollback reason before re-export.</div>
                <div className="mt-1 text-sm leading-6 text-slate-500">Enterprise execution item</div>
              </div>
            </div>
          </article>
