...
export default function CommercialDemoEnvironmentFinal() {
  return (
    <section className="space-y-8">
        ...
        <div className="relative flex flex-col gap-8 xl:flex-row xl:items-end xl:justify-between">
          <div>
            ...
            <p className="mt-5 max-w-3xl text-sm leading-7 text-slate-300">
              Sellable demo environment with demo company, demo story, executive dashboards, pilot readiness and value proof points.
            </p>
          </div>
      ...
      <div className="grid gap-5 md:grid-cols-2 xl:grid-cols-4">
          <article className="rounded-[30px] border border-white/80 bg-white/95 p-6 shadow-[0_20px_60px_rgba(15,23,42,0.12)] backdrop-blur-xl">
            ...
            <div className="mt-6 text-3xl font-black text-slate-950">Ready</div>
            <div className="mt-2 text-sm font-black text-slate-700">Demo Company</div>
          </article>
          <article className="rounded-[30px] border border-white/80 bg-white/95 p-6 shadow-[0_20px_60px_rgba(15,23,42,0.12)] backdrop-blur-xl">
            <div className="w-fit rounded-2xl bg-cyan-100 p-3 text-cyan-700"><Rocket className="h-6 w-6" /></div>
            <div className="mt-6 text-3xl font-black text-slate-950">10 min</div>
            <div className="mt-2 text-sm font-black text-slate-700">Demo Story</div>
          </article>
          <article className="rounded-[30px] border border-white/80 bg-white/95 p-6 shadow-[0_20px_60px_rgba(15,23,42,0.12)] backdrop-blur-xl">
            <div className="w-fit rounded-2xl bg-cyan-100 p-3 text-cyan-700"><BarChart3 className="h-6 w-6" /></div>
            <div className="mt-6 text-3xl font-black text-slate-950">81%</div>
            <div className="mt-2 text-sm font-black text-slate-700">Pilot Readiness</div>
          </article>
          <article className="rounded-[30px] border border-white/80 bg-white/95 p-6 shadow-[0_20px_60px_rgba(15,23,42,0.12)] backdrop-blur-xl">
            <div className="w-fit rounded-2xl bg-cyan-100 p-3 text-cyan-700"><Zap className="h-6 w-6" /></div>
            <div className="mt-6 text-3xl font-black text-slate-950">Strong</div>
            <div className="mt-2 text-sm font-black text-slate-700">Sales Proof</div>
          </article>
      </div>
      ...
      <div className="grid gap-6 xl:grid-cols-[1.1fr_0.9fr]">
        <div className="rounded-[34px] border border-white/80 bg-white/95 p-6 shadow-[0_24px_70px_rgba(15,23,42,0.13)] backdrop-blur-xl">
          ...
          <article className="rounded-[28px] border border-slate-200 bg-white p-5 shadow-sm">
            <div className="flex items-start gap-4">
              ...
              <div>
                <div className="font-black text-slate-950">Create Bluewater Retail Group demo environment.</div>
          ...
          <article className="rounded-[28px] border border-slate-200 bg-white p-5 shadow-sm">
            <div className="flex items-start gap-4">
              ...
              <div>
                <div className="font-black text-slate-950">Show payroll leakage first in the demo.</div>
                <div className="mt-1 text-sm leading-6 text-slate-500">Enterprise execution item</div>
              </div>
            </div>
          </article>
          <article className="rounded-[28px] border border-slate-200 bg-white p-5 shadow-sm">
            <div className="flex items-start gap-4">
              ...
              <div>
                <div className="font-black text-slate-950">Show store pressure and employee proof.</div>
                <div className="mt-1 text-sm leading-6 text-slate-500">Enterprise execution item</div>
              </div>
            </div>
          </article>
          <article className="rounded-[28px] border border-slate-200 bg-white p-5 shadow-sm">
            <div className="flex items-start gap-4">
              ...
              <div>
                <div className="font-black text-slate-950">Show payroll blocker and protected export.</div>
                <div className="mt-1 text-sm leading-6 text-slate-500">Enterprise execution item</div>
              </div>
            </div>
          </article>
          <article className="rounded-[28px] border border-slate-200 bg-white p-5 shadow-sm">
            <div className="flex items-start gap-4">
              ...
              <div>
                <div className="font-black text-slate-950">Show executive dashboards and pilot readiness.</div>
                <div className="mt-1 text-sm leading-6 text-slate-500">Enterprise execution item</div>
              </div>
            </div>
          </article>
          <article className="rounded-[28px] border border-slate-200 bg-white p-5 shadow-sm">
            <div className="flex items-start gap-4">
              ...
              <div>
                <div className="font-black text-slate-950">Use built-in talking points to explain value quickly.</div>
                <div className="mt-1 text-sm leading-6 text-slate-500">Enterprise execution item</div>
              </div>
            </div>
          </article>
        ...
        <div className="rounded-[34px] bg-[#06101f] p-6 text-white shadow-[0_24px_70px_rgba(2,6,23,0.30)]">
          ...
          <p className="mt-4 text-sm leading-7 text-slate-300">
            This turns VYRON CORE from a development project into a product that can be demonstrated and sold.
          </p>
